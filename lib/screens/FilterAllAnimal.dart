...
class FilterAnimalData extends StatefulWidget {
  @override
  FilterAnimalDataState createState() => FilterAnimalDataState();
}

class FilterAnimalDataState extends State<FilterAnimalData> {
  List<Book> books = [];
  String query = '';
