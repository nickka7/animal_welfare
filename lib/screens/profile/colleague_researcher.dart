...
class CollResearcher extends StatefulWidget {
  const CollResearcher({ Key? key }) : super(key: key);

  @override
  _CollResearcherState createState() => _CollResearcherState();
}

class _CollResearcherState extends State<CollResearcher> {
