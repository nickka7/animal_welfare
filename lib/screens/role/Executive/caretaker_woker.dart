...
class CaretakerWoker extends StatefulWidget {
  const CaretakerWoker({ Key? key }) : super(key: key);

  @override
  _CaretakerWokerState createState() => _CaretakerWokerState();
}

class _CaretakerWokerState extends State<CaretakerWoker> {
              ...
              Stack(
                    children: [
                      Align(
                        ...
                        child: Text('${DateFormat("d MMMM yyyy", 'th').formatInBuddhistCalendarThai(myDateTime)}',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 20.0,
