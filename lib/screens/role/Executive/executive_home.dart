            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: FlatButton(
                  child: Flexible(
                    child: Row(
                      children: <Widget>[
                        buildStatCard('จำนวนผู้เข้าชมสวนสัตว์',5, 5, HexColor("#9B7401"))
                      ],
                    )
                  ),
                  onPressed: () => {
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      // ignore: deprecated_member_use
                      child: FlatButton(
                        child: buildStatCard('     เจ้าหน้าที่\nที่มาปฏิบัติงาน',5,  5, HexColor("#3B5998")),
                        onPressed: () => {
                          Navigator.push(
                            context,MaterialPageRoute(
                    ...
                    Container(
                      ...
                      // ignore: deprecated_member_use
                      child: FlatButton(
                        child: buildStatCard('จำนวนสัตว์',5, 5, HexColor("#28B446")),
                        onPressed: () => {
                           Navigator.push(
                            context,MaterialPageRoute(
                              builder: (context) => QuantityVisitors()),
              ...
              Flexible(
                ...
                mainAxisAlignment: MainAxisAlignment.end,
                  children: <Widget>[     
                     Text('อัพเดทข้อมูลล่าสุด : ${DateFormat("dd/MM/yyyy HH:mm").format(myDateTime)}',
